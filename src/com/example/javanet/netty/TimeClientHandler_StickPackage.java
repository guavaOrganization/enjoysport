 ...
 * @since
 */
public class TimeClientHandler_StickPackage extends ChannelHandlerAdapter {
	private static final Logger logger = Logger .getLogger(TimeClientHandler_StickPackage.class.getName());
	private int counter;
	private byte[] req;
	
	public TimeClientHandler_StickPackage() throws UnsupportedEncodingException {
